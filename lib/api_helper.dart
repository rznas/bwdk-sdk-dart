...
String parameterToString(dynamic value) {
  ...
  if (value is ErrorEnum) {
    return ErrorEnumTypeTransformer().encode(value).toString();
  }
  if (value is GatewayTypeEnum) {
    return GatewayTypeEnumTypeTransformer().encode(value).toString();
  }
  ...
  if (value is ShippingTypeEnum) {
    return ShippingTypeEnumTypeTransformer().encode(value).toString();
  }
  if (value is TypeNameEnum) {
    return TypeNameEnumTypeTransformer().encode(value).toString();
  }
