...
class ShippingTypeEnum {
  ...
  static const number1 = ShippingTypeEnum._(1);
  static const number2 = ShippingTypeEnum._(2);
...
/// Transformation class that can [encode] an instance of [ShippingTypeEnum] to int,
...
class ShippingTypeEnumTypeTransformer {
  ...
  int encode(ShippingTypeEnum data) => data.value;
  ...
  ShippingTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case 1: return ShippingTypeEnum.number1;
        case 2: return ShippingTypeEnum.number2;
        default:
          if (!allowNull) {
